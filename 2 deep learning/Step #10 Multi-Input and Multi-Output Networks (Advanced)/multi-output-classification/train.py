...
losses = {
	"El-noo3": "categorical_crossentropy",
	"El-loon": "categorical_crossentropy",
}
lossWeights = {"El-noo3": 1.0, "El-loon": 1.0}
...
H = model.fit(x=trainX,y={"El-noo3": trainCategoryY, "El-loon": trainColorY},
	validation_data=(testX,{"El-noo3": testCategoryY, "El-loon": testColorY}),
	epochs=EPOCHS,
	verbose=1)
...
lossNames = ["loss", "El-noo3_loss", "El-loon_loss"]
...
accuracyNames = ["El-noo3_accuracy", "El-loon_accuracy"]
plt.style.use("ggplot")
