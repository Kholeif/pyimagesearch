...
# python bw2color_video.py --prototxt model/colorization_deploy_v2.prototxt --model model/colorization_release_v2.caffemodel --points model/pts_in_hull.npy --input images/hend_rostom.mp4
...
# otherwise, grab a reference to the video file
    ...
    out = cv2.VideoWriter("output.avi",fourcc, 25.0,(500,230),True)
