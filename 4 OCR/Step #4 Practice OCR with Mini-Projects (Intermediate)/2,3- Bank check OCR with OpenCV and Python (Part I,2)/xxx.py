...
#rectKernel = cv2.getStructuringElement(cv2.MORPH_RECT, (10, 7))
output = []
...
for (gX, gY, gW, gH) in groupLocs:
	...
	(rois, locs) = extract_digits_and_symbols(group, charCnts,5,10)
	...
	cv2.rectangle(image, (gX - 10, gY + delta - 10),(gX + gW + 10, gY + gH + delta+10), (0, 0, 255), 2)
	cv2.putText(image, "".join(groupOutput),(gX - 10, gY + delta - 25), cv2.FONT_HERSHEY_SIMPLEX,0.55, (0, 0, 255), 2)
